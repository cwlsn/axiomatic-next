...
import { NavBar } from '@axiomatic/elements';
...
export function App(): JSX.Element {
  return (
    <ThemeProvider theme={theme}>
      <GlobalStyle />
      <Stack paddingBottom={4} width="900px" marginX="auto">
        <NavBar>
          <Text variant="wordmark">Axiomatic</Text>
          <Box marginRight="auto" />
          <Link href="#">Wowwow</Link>
        </NavBar>
        ...
        <Text>
          ...
          scratch the furniture reaches under door into adjacent room so swat at
          dog. I like to spend my days sleeping and eating fishes that my human
          fished for me we live on a luxurious yacht, sailing proudly under the
          sun, i like to walk on the deck,
        </Text>
        ...
        <Text>
          ...
          nice warm laptop for me to sit on why use post when this sofa is here.
          Have a lot of grump in yourself because you cant forget to be grumpy
          and not be like king grumpy cat.
        </Text>
